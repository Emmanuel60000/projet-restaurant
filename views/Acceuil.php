<body class="body_acceuil">
    ...
    <main class="main_acceuil">
        <div class="main">
            ...
            <h1 class="h1" id="title1">Le BARRIO ALTO</h1>
            <h2 class="h2" id="title2">Réstaurant Portugais</h2>
        ...
        <section>
            <div class="section_article">
                ...
                <div class="article_accueil ">
                    <img class="m-0  img1" id="mon-image" src="https://images.unsplash.com/photo-1518779578993-ec3579fee39f?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1470&q=80" alt="Francesinha">
        ...
        <div class="section_article">
            ...
            <div class="article_accueil">
                <img class=" m-0 img3" id="mon-image" src="https://images.unsplash.com/photo-1595311229337-9b538bd7fdb4?ixlib=rb-4.0.3&ixid=MnwxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8&auto=format&fit=crop&w=1374&q=80" alt="marriage">
