...
<div>
  <p class="p-evenement" >Une fois que vous aurez sélectionné l'événement qui vous plaît, notre équipe se fera un plaisir de travailler avec
    ...
    culinaires, organiser des animations et des décorations sur mesure pour rendre votre soirée unique.</p>
  <p class="p-evenement" >Nous savons que chaque événement est différent, c'est pourquoi nous nous engageons à fournir un service
    personnalisé et de qualité pour répondre à vos besoins spécifiques. Nous sommes fiers d'être un lieu de choix pour
    les événements les plus importants de la vie, et nous avons hâte de vous accueillir bientôt chez nous.</p>
  <p class="p-evenement" >Alors n'hésitez plus et contactez-nous pour réserver votre soirée dans notre restaurant. Consultez notre carrousel
    pour avoir un aperçu de ce qui vous attend chez nous et laissez-nous créer une soirée inoubliable pour vous et vos
    invités !</p>
</div>